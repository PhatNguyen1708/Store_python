...
class admin_store:
    ...
    def show(self):
        ...
        self.admin.b_add = Button(self.admin.frame_down, text="Add", width=10, height=1, bg=co4, font=('Ivy 8 bold'))
        self.admin.b_add.place(x=400, y=50)

        self.admin.b_update = Button(self.admin.frame_down, text="Update", width=10, height=1, bg=co4, font=('Ivy 8 bold'))
